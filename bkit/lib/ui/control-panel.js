 ...
 * @param {Object|null} controlState     - .bkit/runtime/control-state.json
...
function renderControlPanel(controlState, automationLevel, opts = {}) {
  ...
  const stopNotice = `Emergency stop: ${bold('/control stop')}  or  ${bold('Ctrl+C')} ${dim('\u2192 bkit saves checkpoint and halts')}`;
